...
class LoginViewController: UIViewController {
    ...
    @objc private func didTapLoginButton() {
        ...
        AuthManager.instance.loginUser(username: username, email: email, password: password) { success in
            DispatchQueue.main.async {
                if success {
                    self.dismiss(animated: true, completion: nil)
                } else {
                    let alert = UIAlertController(title: "Log In Error", message: "We were unale to log you in.", preferredStyle: .alert)
